    ...
    return (
      <nav>
        ...
        {this.props.showPageNumberForm &&
          <NumericValueForm name="Page Number" placeholder="Page Number" action="Go To Page"
              value={this.props.pageNumber} minValue={1} maxValue={this.props.numberOfPages}
              onSubmit={this.props.onPageNumberChanged}
          />
        }

        {this.props.showPageSizeForm &&
          <NumericValueForm name="Page Size" placeholder="Page Size" action="Change Page Size"
              value={this.props.pageSize} minValue={1}
